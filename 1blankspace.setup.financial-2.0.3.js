	...
	home:		function (oParam, oResponse)
				{
					...
					$('#ns1blankspaceControlInvoiceScheduleTemplate').click(function(event)
					{
						...
						ns1blankspace.show({selector: '#ns1blankspaceMainTemplate_invoiceschedule'});
						ns1blankspace.xhtml.templates.source.invoiceschedule = '/site/' + oRoot.site + '/1blankspace.setup.financial.invoiceschedule-1.0.0.html';
