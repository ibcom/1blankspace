...
ns1blankspace.financial.notes =
{
	show: function ()
	{
		...
		aHTML.push('<table id="ns1blankspaceColumn1" class="ns1blankspace" data-editorcount="' + ns1blankspace.counter.editor + '"">');

		
		aHTML.push('<tr><td>' +
						'<textarea rows="30" cols="50" id="ns1blankspaceFinancialNotes' +
