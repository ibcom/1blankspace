						...
						if (ns1blankspace.financial.initStatus != 2 || bRefresh)
						{
							if (iStep == -1)
							{
								if (oResponse == undefined)
								{
									...
									// /ondemand/setup/setup.asp?method=SETUP_FINANCIAL_SETTINGS_MANAGE&setdefault=1
									//Checking with Chad if setdefault working with /rpc - when sorted set the iStep default from 0 to -1
									$.ajax(
									{
										type: 'POST',
										url: '/rpc/setup/setup.asp?method=SETUP_FINANCIAL_SETTINGS_MANAGE&setdefault=1',
										dataType: 'json',
										global: false,
