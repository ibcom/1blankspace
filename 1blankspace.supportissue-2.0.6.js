...
ns1blankspace.supportIssue = 
{
	...
	layout:		function ()
	{
		...
		else
		{
			...
			{
				aHTML.push('<tr><td id="ns1blankspaceControlForMe" class="ns1blankspace" + style="color: white; background-color: #5B7F00; padding-top: 10px; padding-bottom: 10px;">' +
								'From Customer</td></tr>' +
							'<tr><td class="ns1blankspace">&nbsp;</td></tr>');
			}
		...
		$('#ns1blankspaceControlConversations').click(function(event)
		{
			...
			ns1blankspace.conversations.show({xhtmlElementID: 'ns1blankspaceMainConversations', actions: {add: true}});
		});
	},
			...
			if (oResponse)
			{
				...
				else
				{
					...
					$.extend(oParam,
					{
						...
						functionOnNewPage: ns1blankspace.supportIssue.codes.bind
					}); 	
		...
		edit: function(oParam)
		{
			...
			if (bContinue)
			{
				...
				if (iCodeID)
				{
					...
					$.each(aColumns, function()
					{
						$('#ns1blankspaceManageCodes' + this.name).val(oRow[this.name]);
					});
				}
