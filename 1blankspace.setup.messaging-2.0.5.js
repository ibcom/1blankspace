					...
					send: 	function (sXHTMLElementID, oParam)
								{
									...
									if (sSearchContext != undefined && iSource != ns1blankspace.data.searchSource.browse)
									{
										...
										var oSearch = new AdvancedSearch();
										oSearch.method = 'SETUP_MESSAGING_ACCOUNT_SEARCH';
										oSearch.addField('email,type,typetext,authtype,authtypetext,accountname,server,port,sslport,title,user,usertext,footer,smtpserver,smtpserverport,smtpaccountname,smtpencrypted,verification,verificationtext,sitefrom');
