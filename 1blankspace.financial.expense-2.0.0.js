...
{
	init: 		function interfaceFinancialExpenseMasterViewport(oParam)
				{
					var bShowHome = true
	...
	refresh: 	function interfaceFinancialExpenseRefresh(oResponse)
				{
	...
	search: 	{
					send:		function interfaceFinancialExpenseSearch(sXHTMLElementId, oParam)
								{
					...
					process:	function interfaceFinancialExpenseSearchShow(oParam, oResponse)
								{
	...
	layout: 	function interfaceFinancialExpenseViewport()
				{
	...
	show:		function interfaceFinancialExpenseShow(oParam, oResponse)
				{
					$('#divns1blankspaceViewportControlOptions').hide(ns1blankspace.option.hideSpeedOptions);
	...
	details: 	function interfaceFinancialExpenseDetails()
				{
					var aHTML = [];
					var h = -1;
	...
	new:		function interfaceFinancialExpenseNew(oParam)
				{
					ns1blankspace.objectContextData = undefined
					ns1blankspace.objectContext = -1;
					interfaceFinancialExpenseViewport();
	...
	save: 		{
					send: 		function interfaceFinancialExpenseSave(oParam, oResponse)
								{
									if (oResponse == undefined)
									{
	...
	item: 		{
					...
					remove:		function interfaceFinancialExpenseItemRemove(oParam, oResponse)
								{
									var sXHTMLElementID;
					...
					add:		function interfaceFinanicalExpenseItemAdd(oParam, oResponse)
								{
									var iStep = 1;
	...
	payment: 	{
					...
					add:		function interfaceFinancialExpensePaymentAdd(oParam, oResponse)
								{
									var iStep = 1;
