...
function interfaceViewControllerMasterViewport(aParam)
{
	if (aParam != undefined)
	{
		if (aParam.object != undefined) {giObject = aParam.object}	
	...
	$('#inputInterfaceMasterViewportControlSearch').keyup(function(event)
	{
        ...
        giKeyPressTimeoutId = setTimeout("interface' + goObject.objectCode + 'Search('inputInterfaceMasterViewportControlSearch')", giWaitForStop);
	});
