...
ns1blankspace.financial.bankAccount = 
{
	...
	layout: 	function ()
				{	
					...
					aHTML.push('<tr class="ns1blankspaceControl">' +
									'<td id="ns1blankspaceControlReconcile" class="ns1blankspaceControl">Current</td>' +
									'</tr>');
					...
					edit:	function (oParam, oResponse)
							{
								...
								if (iStep == 1)
								{
									...
									else
									{
										...
										$('[name="radioTaxCode"][value="1"]').attr('checked', true);
									}
								...
								{	
									...
									$('[name="radioTaxCode"][value="' + oRow.taxtype + '"]').attr('checked', true);
								}
