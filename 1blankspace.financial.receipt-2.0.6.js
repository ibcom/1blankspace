					...
					if (oResponse == undefined)
					{
						...
						aHTML.push('<tr class="ns1blankspaceControl">' +
									'<td style="padding-top:18px;" id="ns1blankspaceControlUnallocated" class="ns1blankspaceControl">' +
										'Unallocated<br /><span class="ns1blankspaceSub" style="font-size:0.75em;">Receipt items that have been marked as unallocated and not applied to an invoice.</span></td>' +
									'</tr>');
												...
												{												
															...
															ns1blankspace.financial.receipt.invoice.data.invoiceItemOutstandingAmount != 0)
													{
														...
														$.ajax(
														{
															...
															{
																//change the receipt item allocation to debtors
