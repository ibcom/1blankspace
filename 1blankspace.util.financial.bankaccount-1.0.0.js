...
ns1blankspace.util.financial.bankAccounts =
{
        ...
        init:  function (oParam, oResponse)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    aHTML.push('<tr><td class="ns1blankspaceSubNote"><ul><li>Westpac<li>St George<li>NAB<li>ANZ<li>CBA</ul></td></tr>');
        ...
        accounts:
        {
            init: function (oParam, oResponse)
            {
                ...
                else
                {
                    if (oResponse.data.rows.length != 0)
                    {
                        ...
                        {
                            type: 'GET',
                            url: 'http://127.0.0.1:3000/_accesstokens/' + oResponse.data.rows[0].etag,
                            dataType: 'json',
            ...
            show: function (oParam)
            {
                ...
                aHTML.push('<form action="https://quickstartaunode.yodlee.com.au/authenticate/quickstartau3/?channelAppName=quickstartau" method="post"' +
                                ' name="ns1blankspaceLinkApp" id="ns1blankspaceLinkApp" target="_ns1blankspaceBankAccountLinkingContainer" style="display: none">' +
    ...
    insert into OFMS_Provider (businessid, description) values (-1, 'Yodlee')
go
insert into OFMS_Provider (businessid, description) values (-1, 'Plaid')
go
