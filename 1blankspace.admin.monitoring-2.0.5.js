						...
						else
						{
							...
							if (oResponse.status == 'OK')
							{
								...
								if (oDetail != undefined)
								{
									...
									//sHTML = oDetail.details
					
									//filterXSS
									//oDetail.instance = _.split(_.split(oDetail.details, 'Server Code=')[1], '&')[0];
									...
									if (oDetail.method != '')
									{
										sContainerHTML = sContainerHTML +
											...
											'<div style="font-weight:300; background-color:#F5F5F5; font-size:0.75em; padding:6px;">' + oDetail.parameters + '</div>'
									}
