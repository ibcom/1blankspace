					...
					edit:		function (oParam)
								{
									...
									{					
										...
										else
										{
											...
											aHTML.push('data-method="SETUP_STRUCTURE_ELEMENT_OPTION_SEARCH" ');
											aHTML.push('data-methodfilter="element-EQUAL_TO-' + iElement + '" ');
											aHTML.push('data-id="' + sDataValue + '"');
									...
									.click(function() 
									{
										var oData = 
										{
											...
											text: $('#ns1blankspaceStructureDataElementValue').val(),
											option: $('#ns1blankspaceStructureDataElementValue').attr('data-id')
										}
