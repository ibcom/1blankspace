	...
	layout: 	function ()
				{	
					...
					aHTML.push('<tr class="ns1blankspaceControl">' +
									...
									'<br /><div class="ns1blankspaceSubNote">with statements from <span class="ns1blankspaceFinanialBankAccountBank">bank</span></div></td>' +
									'</tr>');
					...
					refresh:	function (oParam, oResponse)
								{
									...
									else
									{
										...
										if (ns1blankspace.option.bootstrap)
										{
											...
											aHTML.push('<label class="btn btn-default' + (iType==2?' active':'') + '" id="ns1blankspaceBankAccountColumnItemType-2-' + iReconciliation + '">' +
											...
											aHTML.push('<label class="btn btn-default' + (iType==1?' active':'') + '" id="ns1blankspaceBankAccountColumnItemType-1-' + iReconciliation + '">' +
											...
											{	
												...
												aHTML.push('<label class="btn btn-default active" id="ns1blankspaceBankAccountColumnItemMode-1-' + iReconciliation + '">' +
																'<input type="radio" name="radioMode" data-1blankspace="ignore" checked="checked" />' +
																'Unreconciled' +
																'</label>');

												aHTML.push('<label class="btn btn-default" id="ns1blankspaceBankAccountColumnItemMode-2-' + iReconciliation + '">' +
										...
										ns1blankspace.financial.bankAccount.reconcile.attachment.show(
										{
											...
											downloadText: 'Open Bank Statement'
										})
									...
									edit:		function (oParam, oResponse)
												{
													...
													if ($('#' + sXHTMLElementContainerID).html() == '')
													{
														...
														if (ns1blankspace.option.bootstrap)
														{
															...
															{	
																aHTML.push('<label class="btn btn-default" id="ns1blankspaceReconcileItemEdit-1">' +
																					'<input type="radio" name="radioEdit" data-1blankspace="ignore" />Payments & Journals' +
																					'</label>');

																aHTML.push('<label class="btn btn-default" id="ns1blankspaceReconcileItemEdit-2">' +
