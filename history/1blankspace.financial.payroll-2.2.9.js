					...
					show: 	function (oParam, oResponse)
								{
									...
									if (iStep == 1)	
									{
										...
										if (oResponse == undefined)
										{
											...
											oSearch.addField('contactpersontext,employmentstartdate,employmentenddate,statustext,employeenumber,employee.contactperson.firstname,employee.contactperson.surname');
