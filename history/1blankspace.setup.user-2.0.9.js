						...
						else
						{
							...
							{	
								...
								aHTML.push('<td id="ns1blankspaceMostLikely_title-' + this.id + 
														...
														ns1blankspace.setup.user.util.getUsername({username: this.username}) + 
														'</td>');
					...
					send: 		function (sXHTMLElementId, iSource, sSearchText, sSearchContext)
								{
									...
									if (sSearchContext != undefined && iSource != ns1blankspace.data.searchSource.browse)
									{
										...
										oSearch.addField('username,contactpersontext,contactperson,lastlogon,disabled,disabledreason,unrestrictedaccess,authenticationlevel,' +
															'authenticationdelivery,timezoneoffset,passwordexpiry,contactbusinesstext,contactbusiness,guid,sessiontimeout,relationshipmanagersecuritytype');
	...
	details: 	function ()
				{
					...
					if ($('#ns1blankspaceMainDetails').attr('data-loading') == '1')
					{
						...
						aHTML.push('<tr class="ns1blankspaceCaption">' +
										...
										'<tr class="ns1blankspace">' +
										'<td class="ns1blankspaceText">' +
										'<input id="ns1blankspaceDetailsPassword" class="ns1blankspaceText" type="password">' +
										'</td></tr>');
					...
					show:		function (oParam, oResponse)
								{
									...
									if (iStep == 1)
									{
										if (oResponse == undefined)
										{
											...
											oSearch.addField('userlogon,spacetext,usercontactpersontext,unrestrictedaccess,user,targetuser,targetusertext,createddate');
											oSearch.rows = 50;
