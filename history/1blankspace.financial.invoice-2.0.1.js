					...
					send: 		function (sXHTMLElementID, oParam)
								{
									...
									if (sSearchContext != undefined  && iSource != ns1blankspace.data.searchSource.browse)
									{
										...
										oSearch.addField('contactbusinesssenttotext,contactbusinesssentto,contactpersonsenttotext,contactpersonsentto,' +
																...
																'receiptamount,outstandingamount,creditamount,' +
					...
					show: 		function (oParam)
								{
									...
									tinyMCE.execCommand('mceAddControl', false, 'ns1blankspaceMessageText' + ns1blankspace.counter.editor);
					...
					send:		function (oParam, oResponse)
								{
									if (oResponse == undefined)
									{
										...
										if ($('#ns1blankspaceMainDetails').html() != '')
										{
											...
											sData += '&contactbusinesssentto=' + ns1blankspace.util.fs($('#ns1blankspaceDetailsContactBusinessSentTo').attr("data-id"));
											sData += '&contactpersonsentto=' + ns1blankspace.util.fs($('#ns1blankspaceDetailsContactPersonSentTo').attr("data-id"));
