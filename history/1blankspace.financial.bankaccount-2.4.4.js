					...
					refresh:	function (oParam, oResponse)
								{
									...
									else
									{
										...
										{	
											...
											aHTML.push('<input style="width: 100%;" type="radio" id="ns1blankspaceBankAccountColumnItemMode-1-' + iReconciliation + '" name="radioMode" checked="checked" /><label for="ns1blankspaceBankAccountColumnItemMode-1-' + iReconciliation + '" style="width:90px; margin-bottom:1px; padding-left:2px;">' +
															'Unreconciled</label>');
											aHTML.push('<input style="width: 100%;" type="radio" id="ns1blankspaceBankAccountColumnItemMode-2-' + iReconciliation + '" name="radioMode" /><label for="ns1blankspaceBankAccountColumnItemMode-2-' + iReconciliation + '" style="width: 90px; padding-left:2px;">' +
															'Reconciled</label>');
											aHTML.push('</div>');
										...
										else
										{
											...
											if (oResponse.data.rows != 0)
											{
												...
												$('#' + sXHTMLElementID).html(
													'<a target="_self" style="color:#999999;" href="' + oResponse.data.rows[0].download + '" class="ns1blankspaceNoUnloadWarn">' +  sDownloadText + '</a>');
											}
											else
											{
												$('#' + sXHTMLElementID).html('');
