...
[
	...
	},
	{
		...
		source: '/site/1433/1blankspace.setup.user-2.1.1.js'
	},
	{
	...
	},
	{
		...
		search:
		{
			...
			[
				...
				{
					caption: 'Message<br /><span style="font-size:0.75em;">(only messages opened or automatically imported will be searched)</span>',
					name: "message",
					type: 'Text',
					comparison: 'TEXT_IS_LIKE',
					fixed: false
