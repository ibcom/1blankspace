						...
						if (ns1blankspace.financial.data.bankaccounts)
						{
							...
							{	
								...
								aHTML.push('<tr><td class="ns1blankspaceHeaderCaption" style="vertical-align:bottom;">Name</td>' +
												...
												'<td class="ns1blankspaceHeaderCaption" style="width:110px;text-align:center;">Unreconciled Transactions</td>' +
												'</tr>');
								...
								$.each(ns1blankspace.financial.data.bankaccounts, function()
								{
									aHTML.push('<tr class="ns1blankspaceRow">' +
													...
													'-</td>' +
													'<td id="ns1blankspaceBankAccount_unreconciled-' + this.id + '" class="ns1blankspaceRow ns1blankspaceSub" style="width:100px;text-align:center;">' +
													'-</td>' +
													'<td>&nbsp;</td></tr>');
								});
