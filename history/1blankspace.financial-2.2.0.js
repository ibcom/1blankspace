	...
	show:	function (oParam, oResponse)
			{
				...
				{	
					...
					var oSearch = new AdvancedSearch();
					oSearch.method = 'FINANCIAL_ITEM_SEARCH';
					oSearch.addField('otherobjectcontext,objectcontext,object,otherobject,financialaccount,financialaccounttext,taxtype,tax,issuedamount,amount,description,' + sOutstanding + 'outstandingamount,preadjustmentamount,preadjustmenttax');
