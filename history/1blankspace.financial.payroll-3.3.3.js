									...
									if (iStep == 22)
									{
										...
										else
										{
											if (oResponse == undefined)
											{
												...
												oSearch.addField('payemployeeleave.period.paydate,typetext,hours,itemtext,notes');
												oSearch.addFilter('employee', 'EQUAL_TO', iEmployee);
											...
											else
											{
												...
												{	
													...
													$(oResponse.data.rows).each(function(i, item) 
													{
														...
														aHTML.push('<td id="ns1blankspaceFinancialPayPeriodItem_notes-' + this.id + '" class="ns1blankspaceRow">' +
																				this.notes + '</td>');
	...
	show: 	function (oParam, oResponse)
				{
					...
					if (oResponse == undefined)
					{
						...
						aHTML.push('<table class="ns1blankspaceMain" style="width:100%;">' +
								'<tr>' +
								'<td id="ns1blankspacePayrollLeaveColumn1" class="ns1blankspaceColumn1Divider" style="width:100px; font-size: 0.875em; padding-right:10px;"></td>' +
