...
ns1blankspace.home = 
{
	...
	show: 		function ()
				{	
					...
					aHTML.push('<tr class="ns1blankspaceViewportControl">' +
					...
					aHTML.push('<tr class="ns1blankspaceViewportControl">' +
									'<td id="ns1blankspaceControlActionCalendar" class="ns1blankspaceControl ns1blankspaceControlHome">' +
										'Calendar</td>' +
									'</tr>');
					...
					aHTML.push('<div id="ns1blankspaceMainHome" class="ns1blankspaceControlMain">');
					aHTML.push('<table id="ns1blankspaceHomeContainer">');
					...
					if (ns1blankspace.xhtml.homeNotes == '' || ns1blankspace.xhtml.homeNotes == undefined)
					{
						$('#ns1blankspaceHomeColumn2').css('width', '0px');
					}
					else
					{
	...
	bind: 		function ()
				{
					...
					{
						ns1blankspace.show({selector: '#ns1blankspaceMainHome'});
					...
					$('#ns1blankspaceControlActionCalendar').click(function(event)
					{
						...
						ns1blankspace.action.calendar.show({
							xhtmlElementID: 'ns1blankspaceMainCalendar'
							})
					});
	...
	show: 	function (oElement)
				{
					...
					else
					{
						...
						aHTML.push('<tr><td id="ns1blankspaceHomeOptionsFavourites" class="ns1blankspaceRowSelect">' +
										'Favourites<br />' +
										'<span class="ns1blankspaceSubNote">Favourites & tags</span>' +
										'</td></tr>');
	...
	bind:		function ()
				{
					...
					$('#ns1blankspaceHomeOptionsFavourites').click(function(event)
					{
						$(ns1blankspace.xhtml.container).attr('data-initiator', '');
						ns1blankspace.favourite.init();
					});

					$('#ns1blankspaceHomeOptionsSearch').click(function(event)
					{
						$(ns1blankspace.xhtml.container).attr('data-initiator', '');
						ns1blankspace.report.init();
					});
				}
}				
