					...
					send:		function (sXHTMLElementId, oParam)
								{
									...
									if (sSearchContext != undefined  && iSource != ns1blankspace.data.searchSource.browse)
									{
										...
										oSearch.addField('contactbusinesspaidtotext,contactbusinesspaidto,contactpersonpaidtotext,contactpersonpaidto,projecttext,project,projecttext,areatext,' +
																'area,reference,accrueddate,description,amount,outstandingamount,tax,object,objectcontext,paymentduedate,payeereference,creditamount');
					...
					else
					{
						...
						else
						{
							...
							else
							{
								...
								aHTML.push('<tr><td id="ns1blankspaceFinancialOutstandingFileStatus" style="padding-top:5px; padding-bottom:12px; font-size:0.75em; width:115px;" class="ns1blankspaceSub">' +
						...
						aHTML.push('<tr><td class="ns1blankspaceText" style="padding-top:0px;">' +
						...
						aHTML.push('<tr><td id="ns1blankspaceFinancialOutstandingTotal" style="padding-top:0px; font-size:1.2em;" class="ns1blankspaceSub">' +
										'</td></tr>');
						...
						{
							$('#ns1blankspaceExpenseOutstandingColumn2 table').after(aHTML.join(''));
						}	
