	...
	details: 	function (oParam)
				{
					...
					aHTML.push('<tr>' +
									'<td class="ns1blankspaceCaption ns1blankspaceRowShaded" style="padding:8px;">' +
									'<div>If no values entered...</div>' +
									'<div class="ns1blankspaceSubNote" style="padding-top:12px;">User access is disabled if the password is entered incorrectly 5 times within a 10 minute duration.</div>' +
									'<div class="ns1blankspaceSubNote" style="padding-top:12px;">User access is automatically re-enabled after 30 minutes.</div>' +
									'</td></tr>');
					...
					index: 	
								{
									...
									process: function (oParam, oResponse)
									{
										...
										if (oResponse == undefined)
										{
											var oSearch = new AdvancedSearch();
											oSearch.method = 'CORE_ATTACHMENT_SEARCH';		
											oSearch.addField('bucketfilename,buckettext,filename,objecttext,objectcontext,createddate,attachment,guid');
											oSearch.addSummaryField('count(id) count')
