...
ns1blankspace.product = 
{
	...
	{			
		show: 		function ()
		{
			if ($('#ns1blankspaceMainPricing').attr('data-loading') == '1')
			{
				...
				aHTML.push('<table class="ns1blankspaceContainer">' +
								...
								'</tr>' + 
								'<tr class="ns1blankspaceContainer">' +
								'<td id="ns1blankspacePricingRow2" class="ns1blankspaceColumn1" colspan="2" style="padding-top: 30px;">' + 
									ns1blankspace.xhtml.loading +
								'</td></tr>' +
								'</table>');					
		...
		history: function(oParam)
		{
			...
			if (ns1blankspace.objectContextData.priceHistory == undefined)
			{
				var oSearch = new AdvancedSearch();
					...
					if (oResponse.status == 'OK')
					{
						if (oResponse.data.rows.length > 0)
						{
							...
							aHTML.push('<tr>' +
											...
											'<td class="ns1blankspaceHeaderCaption">Sell Price (incl ' + ns1blankspace.option.taxVATCaption + ')</td>' + 
							...
							{
								aHTML.push('<tr>' + 
												'<td class="ns1blankspaceRow">' + this.effectivefromdate.replace(' 00:00:00', '') + '</td>' +
												'<td class="ns1blankspaceRow">' + this.effectivetodate.replace(' 00:00:00', '') + '</td>' +
						...
						$('#ns1blankspacePricingRow2').html(aHTML.join(''));
					}
				});
			}
		}
				...
				$.ajax(
				{
					...
					success: function(oResponse)
					{
						...
						else
						{
							...
							$('#ns1blankspaceControlPricing').click();
						}
					}
				});
			}
