...
function interfaceFinancialHomeShow(aParam, oXML)
{
...
function interfaceFinancialSummary(aParam, oJSON)
{
	...
	else
	{
		...
		//parseFloat(oJSON.TotalSales).toFixed(2) +
...
function interfaceFinancialDebtors(aParam, oJSON)
{
...
function interfaceFinancialCreditors(aParam, oJSON)
{
...
function interfaceFinancialProfitLoss(aParam, oJSON)
{
...
function interfaceFinancialBalanceSheet(aParam, oJSON)
{
...
function interfaceFinancialBankAccount(aParam, oJSON)
{
...
function interfaceFinancialUnallocated(aParam, oJSON)
{
