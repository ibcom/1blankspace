...
function interfaceSetupAutomationHomeShow(oXML)
{
...
function interfaceSetupAutomationSearchShow(aParam, oXML)
{
...
function interfaceSetupAutomationShow(aParam, oXML)
{
...
function interfaceSetupAutomationSummary()
{
	...
	else
	{
		...
		aHTML[++h] = '<tr><td id="tdInterfaceMainSummaryAutomationEndpoint" class="interfaceMainSummary">Endpoint</td></tr>' +
						...
						onDemandXMLGetData(oRow, 'endpoint') +
						'</td></tr>';
...
function interfaceSetupAutomationDetails()
{
	...
	var oRoot = goSetupContextXML.getElementsByTagName('ondemand').item(0);
	...
	if ($('#divInterfaceMainDetails').attr('onDemandLoading') == '1')
	{
		...
		if (oRoot.childNodes.length != 0)
		{
			...
			$('#inputInterfaceMainDetailsEndpoint').val(onDemandXMLGetData(oRow, 'endpoint'));
			$('#inputInterfaceMainDetailsURL').val(onDemandXMLGetData(oRow, 'url'));
			$('#inputInterfaceMainDetailsURLMethod').val(onDemandXMLGetData(oRow, 'urlmethod'));
			$('#inputInterfaceMainDetailsPostData').val(onDemandXMLGetData(oRow, 'postdata'));
			
			$('[name="radioStatus"][value="' + onDemandXMLGetData(oRow, 'status') + '"]').attr('checked', true);
			$('[name="radioInContext"][value="' + onDemandXMLGetData(oRow, 'incontext') + '"]').attr('checked', true);
		}
		else
		{
...
function interfaceSetupAutomationSchedule()
{
	...
	if ($('#divInterfaceMainSchedule').attr('onDemandLoading') == '1')
	{
		...
		if (oRoot.childNodes.length != 0)
		{
			$('#inputInterfaceMainScheduleTimeHour').val(onDemandXMLGetData(oRow, 'scheduletimehour'));
			$('#inputInterfaceMainScheduleTimeMinute').val(onDemandXMLGetData(oRow, 'scheduletimeminute'));
			$('[name="radioScheduleType"][value="' + onDemandXMLGetData(oRow, 'scheduletype') + '"]').attr('checked', true);
		}
		else
		{
...
function interfaceSetupAutomationResponse()
{
	...
	if ($('#divInterfaceMainResponse').attr('onDemandLoading') == '1')
	{
		...
		if (oRoot.childNodes.length != 0)
		{
			$('[name="radioResponseAction"][value="' + onDemandXMLGetData(oRow, 'responseaction') + '"]').attr('checked', true);
			$('#inputInterfaceMainResponseActionContext').val(onDemandXMLGetData(oRow, 'responseactioncontext'));
			$('#inputInterfaceMainResponseActionFrom').val(onDemandXMLGetData(oRow, 'responseactionfrom'));
			$('#inputInterfaceMainResponseActionURL').val(onDemandXMLGetData(oRow, 'responseactionurl'));
		}
		else
		{
...
function interfaceSetupAutomationFormat()
{
	...
	if ($('#divInterfaceMainFormat').attr('onDemandLoading') == '1')
	{
		...
		if (oRoot.childNodes.length != 0)
		{
			$('#inputInterfaceMainFormatCaption').val(onDemandXMLGetData(oRow, 'caption'));
			$('#inputInterfaceMainFormatCSSClass').val(onDemandXMLGetData(oRow, 'cssclass'));
			$('#inputInterfaceMainFormatXHTMLStyle').val(onDemandXMLGetData(oRow, 'xhtmlstyle'));
			$('#inputInterfaceMainFormatXHTMLAHref').val(onDemandXMLGetData(oRow, 'xhtmlahref'));
		}
...
function interfaceSetupAutomationSave(oResponse)
{
	...
	if (oResponse == undefined)
	{
		...
		var sParam = 'method=SETUP_AUTOMATION_MANAGE&rf=JSON';
		var sData = '';
...
function interfaceSetupAutomationNew(oXML)
{
	if (oXML == undefined)
	{
		...
		$.ajax(
		{
			...
			dataType: 'xml',
			success: interfaceSetupAutomationNew
		});
	}	
	else	
	{
