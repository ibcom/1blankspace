...
function interfaceSetupProjectHomeShow(oXML)
{
	...
	else
	{
		...
		else
		{
			...
			for (var iRow = 0; iRow < oRoot.childNodes.length; iRow++) 
			{
				...
				aHTML[++h] = '<td id="interfaceSetupProjectHomeMostLikely_Title-' + onDemandXMLGetData(oRow, "id") + '" class="interfaceHomeMostLikely">' +
...
function interfaceSetupProjectSearchShow(aParam, oXML)
{
...
function interfaceSetupProjectShow(aParam, oXML)
{
...
function interfaceSetupProjectTasks(aParam, oXML)
{
...
function interfaceSetupProjectTasksRow(oRow)
{
	...
	aHTML[++h] = '<td id="tdSetupProjectTasks_title-' + onDemandXMLGetData(oRow, "id") + '" class="interfaceMainRow">' +
							onDemandXMLGetData(oRow, "title") + '</td>';
							
	aHTML[++h] = '<td class="interfaceMainRow" style="width: 40px;text-align:right;"><span id="tdSetupProjectTasks_delete-' + onDemandXMLGetData(oRow, "id") + '" class="interfaceMainRowOptionsDelete">&nbsp;</span>';
	aHTML[++h] = '<span id="tdSetupProjectTasks_select-' + onDemandXMLGetData(oRow, "id") + '" class="interfaceMainRowOptionsSelect">&nbsp;</span></td>';
...
function interfaceSetupProjectTasksSlide()
{
	var aHTML = [];
	var h = -1;
...
function interfaceSetupProjectTaskDetailsAdd(aParam, oXML)
{
