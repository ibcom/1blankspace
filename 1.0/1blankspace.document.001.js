...
function interfaceDocumentHomeShow(oXML)
{
...
function interfaceDocumentSearch(sXHTMLElementId, aParam)
{
	...
	if (sSearchContext != undefined && iSource != giSearchSource_BROWSE)
	{
		...
		var sParam = 'method=DOCUMENT_SEARCH&advanced=1&select=' + giObjectContext;
	...
	else
	{
		...
		if (sSearchText.length >= iMinimumLength || iSource == giSearchSource_BROWSE)
		{
			...
			var sParam = 'method=DOCUMENT_SEARCH&rf=XML' +
...
function interfaceDocumentSearchShow(aParam, oXML)
{
...
function interfaceDocumentShow(aParam, oXML)
{
	...
	if (oRoot.childNodes.length == 0)
	{
		aHTML[++h] = '<table><tbody><tr><td class="interfaceMainRowNothing" valign="top">Sorry can\'t find contact.</td></tr>';
...
function interfaceDocumentSummary()
{
	...
	else
	{
		...
		if (onDemandXMLGetData(oRow, 'summary') == '')
		{
...
function interfaceDocumentDetails()
{
	...
	if ($('#divInterfaceMainDetails').attr('onDemandLoading') == '1')
	{
		...
		aHTML[++h] = '<tr id="trInterfaceMainDetailsURL" class="interfaceMain">' +
						...
						'<input onDemandType="TEXT" id="inputInterfaceMainDetailsURL" class="inputInterfaceMainText">' +
						'</td></tr>';
	...
	if ($('#divInterfaceMainEdit').attr('onDemandLoading') == '1')
	{
		...
		if (sReturn == undefined)
		{
			...
			if (giObjectContext != -1)
			{
				...
				sParam = 'method=DOCUMENT_GET_DOCUMENT&noformat=1&noparse=1&select=' + onDemandXMLGetData(oRow, 'id')
