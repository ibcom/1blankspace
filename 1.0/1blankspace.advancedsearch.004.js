var gaAdvandSearchComparison =
		[ 
			...
			{title: "Is empty", code: "IS_EMPTY", dataType: "text", inputCount: 0},
			{title: "Is not empty", code: "IS_NOT_EMPTY", dataType: "text", inputCount: 0},
...
function advancedSearchComparisonGet(aParam)
{
	...
	$.each(gaAdvandSearchComparison, function()
	{
		if (this.dataType == sDataType || (bIncludeAll && this.dataType == 'all'))
		{
