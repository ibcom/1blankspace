					...
					if (iStep == 1)
					{
						...
						if (oResponse == undefined)
						{
							...
							oSearch.addField('payrecord.employee.contactperson,payrecord.employee.employeenumber,payrecord.employee.contactperson.firstname,' + 
												...
												',grosssalary,netsalary,superannuation,taxafterrebate');
						...
						else
						{
							...
							else
							{
								...
								$(oResponse.data.rows).each(function()
								{
									...
									if (true)
									{
										aHTML.push('<br /><span class="ns1blankspaceSub">' + this["grosssalary"] + '</span> <span class="ns1blankspaceSubNote">(gross salary)</span>');
										aHTML.push('<br /><span class="ns1blankspaceSub">' + this["taxafterrebate"] + '</span> <span class="ns1blankspaceSubNote">(tax)</span>');
										aHTML.push('<br /><span class="ns1blankspaceSub">' + this["netsalary"] + '</span> <span class="ns1blankspaceSubNote">(net salary)</span>');
										aHTML.push('<br /><span class="ns1blankspaceSub">' + this["superannuation"] + '</span> <span class="ns1blankspaceSubNote">(superannuation)</span>');
									}
