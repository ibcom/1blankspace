	...
	summary: function ()
				{
					...
					else
					{
						...
						aHTML.push('<tr><td class="ns1blankspaceSummaryCaption">Name</td></tr>' +
										...
										'<div data-id="' + ns1blankspace.objectContextData.contactperson + '" data-object="contactPerson" class="ns1blankspaceSummary ns1blankspaceViewLink">' +
											ns1blankspace.objectContextData.contactpersontext + '</div>');
