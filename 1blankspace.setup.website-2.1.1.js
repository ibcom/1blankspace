					...
					edit:		function (oParam, oResponse)
								{
									...
									if (oResponse == undefined)
									{
										...
										aHTML.push('<td class="ns1blankspaceRadio"><input type="checkbox" id="ns1blankspaceWebsitePageIgnoreHead" />' +
														'Ignore Site Header</td>');

										aHTML.push('<td class="ns1blankspaceRadio"><input type="checkbox" id="ns1blankspaceWebsitePageIgnoreTemplate" />' +
														'Ignore Site Template</td></tr>');
										...
										.click(function() 
										{
											...
											if ($('#ns1blankspaceWebsitePageIgnoreTemplate:checked').length!=0)
											{
												sData += '&documentlayoutdocument=-2';
											}
											else
											{
												sData += '&documentlayoutdocument=';
											}
