					...
					recent:		function (oResponse)
								{
									if (oResponse == undefined)
									{
										...
										oSearch.addField('reference,orderbybusinesstext,orderbypersontext,orderdate,notes');
										oSearch.rows = 50;
									...
									else
									{
										...
										else
										{
											...
											aHTML.push('<td class="ns1blankspaceHeaderCaption" style="width:100px;">Reference</td>');
											aHTML.push('<td class="ns1blankspaceHeaderCaption" style="width:100px;">Order Date</td>');
											aHTML.push('<td class="ns1blankspaceHeaderCaption" style="width:120px;">Order By</td>');
											...
											$.each(oResponse.data.rows, function()
											{
												...
												aHTML.push('<td id="ns1blankspaceMostLikely_title-' + this.id + 
																		'" class="ns1blankspaceRow ns1blankspaceRowSelect style="width:100px;" >' +
																		this.reference + '</td>');
												
												aHTML.push('<td id="ns1blankspaceMostLikely_orderdate-' + this.id + '" class="ns1blankspaceRow" style="width:100px;">' +
																		ns1blankspace.util.fd(this.orderdate) + '</td>');
																		
												var sContact = this.orderbybusinesstext;
												if (sContact == '') {sContact = this.orderbypersontext}
																		
												aHTML.push('<td id="ns1blankspaceMostLikely_contact-' + this.id + '" class="ns1blankspaceRow">' +
																		sContact + '</td>');

												aHTML.push('<td id="ns1blankspaceMostLikely_notes-' + this.id + '" class="ns1blankspaceRow">' +
																		this.notes + '</td>');
									...
									row:		function (oRow)
												{
													...
													aHTML.push('<td id="ns1blankspaceMostLikely_orderdate-' + oRow.id + '" class="ns1blankspaceRow" style="width:100px;">' +
																		ns1blankspace.util.fd(oRow.orderdate) + '</td>');
																		
													var sContact = oRow.orderbybusinesstext;
													if (sContact == '') {sContact = oRow.orderbypersontext}
																			
													aHTML.push('<td id="ns1blankspaceMostLikely_contact-' + oRow.id + '" class="ns1blankspaceRow">' +
																		sContact + '</td>');

													aHTML.push('<td id="ns1blankspaceMostLikely_notes-' + oRow.id + '" class="ns1blankspaceRow">' +
																		oRow.notes + '</td>');
					...
					else
					{
						...
						{	
							aHTML.push('<tr><td class="ns1blankspaceSummaryCaption">Business</td></tr>' +
											'<tr><td id="ns1blankspaceSummaryOrderByBusiness" class="ns1blankspaceSummary">' +
