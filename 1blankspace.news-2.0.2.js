	...
	init: 		function (oParam)
				{
					...
					if (false && ns1blankspace.option.richTextEditing)
					{
						tinyMCE.init(
						{
							mode : "none",
					...
					send: 		function ()
								{
									...
									{
										sData += '&newsbody=' + ns1blankspace.util.fs(tinyMCE.get('ns1blankspaceEditText' + ns1blankspace.counter.editor).getContent());
									}
