...
ns1blankspace.supportIssue = 
{
	...
	home: 
	{
		show: function (oParam, oResponse)
		{
			...
			if (oResponse == undefined)
			{
				...
				{
					oParam.onComplete = ns1blankspace.supportIssue.home.show;
				...
				else if (oParam.issueHomeStep === 2)
				{
					...
					aHTML.push('<tr><td class="ns1blankspaceSub" style="padding-top:15px; font-size:0.875em; border-bottom-style:solid; border-width: 0px; border-color: #D0D0D0;">' +
									'RECENT</td></tr>');

					aHTML.push('<tr class="ns1blankspaceControl">' +
									'<td id="ns1blankspaceControl-1" class="ns1blankspaceControl ns1blankspaceMyIssues" style="padding-right:3px;">' +
									'By Me</td></tr>');			
							
					aHTML.push('<tr class="ns1blankspaceControl">' +
									'<td id="ns1blankspaceControl-2" class="ns1blankspaceControl ns1blankspaceMyIssues" style="padding-right:3px;">' +
									'For Me</td></tr>');	
					...
					$('td.ns1blankspaceMyIssues').click(function(event)
					{
						...
						ns1blankspace.supportIssue.home.show({supportIssueStep: 3});
					});
					...
					ns1blankspace.supportIssue.home.show(oParam);
				}
				else if (oParam.issueHomeStep == 3)
				{
					...
					oSearch.getResults(function(data) {ns1blankspace.supportIssue.home.show(oParam, data)});
				}
			}
			else
			{
				...
				else
				{
					...
					$.each(oResponse.data.rows, function()
					{
						...
						aHTML.push('<td id="ns1blankspaceMostLikely_Reference-' + this.id + '" class="ns1blankspaceRow ns1blankspaceRowSelect" style="width:50px;">' +
												this.reference + '</td>');
						
						aHTML.push('<td id="ns1blankspaceMostLikely_Date-' + this.id + '" class="ns1blankspaceRow" style="width:75px;" style="padding-left:10px;">' +
						...
						aHTML.push('<td id="ns1blankspaceMostLikely_Status-' + this.id + '" class="ns1blankspaceRow ns1blankspaceSub" style="width:100px;">' +
												(this.statustext=='[Not Assigned]'?'-':this.statustext) + '</td>');
			...
			if (ns1blankspace.objectContextData.subject != '')
			{
				...
				if (ns1blankspace.objectContextData.solution != '')
				{
					aHTML.push('<tr><td class="ns1blankspaceSummaryCaption">Solution</td></tr>' +
									...
									ns1blankspace.util.toBR(ns1blankspace.objectContextData.solution) +
									'</td></tr>');
				}		
			}
	...
	details: function ()
	{
		...
		if ($('#ns1blankspaceMainDetails').attr('data-loading') == '1')
		{
			...
			aHTML.push('<tr class="ns1blankspaceCaption">' +
							'<td class="ns1blankspaceCaption">' +
							(ns1blankspace.supportIssue.data.mode.value==ns1blankspace.supportIssue.data.mode.options.forMe?'Assigned To':'Send To') +
							'</td></tr>' +
							'<tr class="ns1blankspace">' +
