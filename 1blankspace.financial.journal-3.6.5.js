	...
	refresh:	function (oResponse)
				{
					...
					else
					{
						...
						if (parseInt(ns1blankspace.objectContextData.balanceTax) !== 0)
						{
							...
							sHTML += '<span style="background-color:orange; color: white;">' +
					...
					process:	function (oParam, oResponse)
								{
									...
									{		
										...
										$.each(oResponse.data.rows, function()
										{	
											aHTML.push(ns1blankspace.financial.journal.search.row(this, oParam));
										});
					...
					show:	function (oParam, oResponse)
							{
								...
								{	
									...
									oSearch.addField('area,areatext,capital,creditamount,credittax,debitamount,debittax,' +
														...
														'taxreport,taxreportfield,taxreportfield2,taxreporttext,taxtype,taxtypeexpensetext,taxtyperevenuetext,notes');
								...
								else
								{
									...
									else
									{
										...
										aHTML.push('<td class="ns1blankspaceHeaderCaption" style="text-align:center;">Category</td>');
										...
										$.each(oResponse.data.rows, function()
										{
											...
											var sAccount = '<div>' + this["financialaccounttext"] + '</div>';
											
											if (this["notes"] != '')
											{
												sAccount = sAccount + '<div class="ns1blankspaceSubNote">' + this["notes"] + '</div>';
											}	
											...
											aHTML.push('<td id="ns1blankspaceItem_reconciled-' + this.id + '" class="ns1blankspaceRow ns1blankspaceSub" style="text-align:center;"' +
															'">' + (this["reconciliation"]==''?'-':'Reconciled') + '</td>');

											aHTML.push('<td id="ns1blankspaceItem_taxcategory-' + this.id + '" class="ns1blankspaceRow ns1blankspaceSub" style="text-align:center;"' +
															'>' +
															this["taxcategorytext"] + '</td>');
								...
								else
								{
									...
									{	
										...
										.click(function()
										{
											...
											sData += '&notes=' + ns1blankspace.util.fs($('#ns1blankspaceItemDescription').val());
