...
if (ns1blankspace.setup.import === undefined) {ns1blankspace.setup.import = {}}
	...
	initData: 	function (oParam)
				{
					...
					ns1blankspace.import.imports =
						[
							{
								name: "Import Businesses",
								method: "CONTACT_BUSINESS",
								functionImport: ns1blankspace.contactBusiness.search.send,
	...
	init: 		function (oParam)
				{
					...
					ns1blankspace.parentObjectName = 'setup';
					ns1blankspace.objectName = 'import';
					ns1blankspace.viewName = 'Imports';
	...
	home:		function (oParam, oResponse)
				{
					...
					aHTML[++h] = '<tr><td><div id="ns1blankspaceViewImportLarge" class="ns1blankspaceViewImageLarge"></div></td></tr>';
					...
					aHTML[++h] = '<div id="ns1blankspaceMainImport" class="ns1blankspaceMain"></div>';
					
					$('#ns1blankspaceMain').html(aHTML.join(''));
					
					$.each(ns1blankspace.import.imports, function()
					{
						var sName = (this.name).replace(/ /g,'')
					...
					if (ns1blankspace.import.imports.length == 1)
					{
						ns1blankspace.show({selector: '#ns1blankspaceMainReport'});
						var sMethod = ns1blankspace.import.importa[0].method;
						ns1blankspace.import.show(ns1blankspace.report.reports[0]);
					...
					{	
						...
						aHTML[++h] = '<table>';
						aHTML[++h] = '<tr iclass="interfaceViewportMain">' +
										'<td class="ns1blankspaceSub">' +
										'Select a import type from left.' + 
										'</td>' +
										'</tr>';
						aHTML[++h] = '</table>';					
