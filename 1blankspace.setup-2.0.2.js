	...
	home:		function (oParam, oResponse)
				{
					...
					if (oResponse === undefined)
					{
						...
						if (bAdvancedSearch)
						{
							...
							{
								if (typeof ns1blankspace.setup.searchParam.sort == 'string')
								{
									ns1blankspace.setup.searchParam.sort = [
									{
										name: ns1blankspace.setup.searchParam.sort,
										direction: 'asc'
									}]
								}
					...
					else
					{
						...
						aHTML.push('<td class="ns1blankspaceHeaderCaption" style="text-align:right"><span id="ns1blankspaceSetupAdd"></span></td>');
						aHTML.push('</tr>');
