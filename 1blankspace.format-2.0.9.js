...
ns1blankspace.format.tags =
		[
			...
			},
			{
				...
				type: 1,
				caption: "First name",
				source: "contactperson.firstname"
			},
			{
				object: 17,
				type: 1,
				caption: "Last name",
				source: "contactperson.surname"
			},
...
ns1blankspace.format.render = function (oParam)
{
	...
	$('span.template', oXHTML).each(function(i,e) 
	{
		...
		if (oTemplateTag[0])
		{
			...
			{
				$(e).attr('data-format-source-method', oTemplateTag.sourceMethod);
				$(e).attr('data-format-source-method-namespace', oTemplateTag.sourceMethodRootNamespace);
			}
