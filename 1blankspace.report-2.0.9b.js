		...
		[
			...
			*/
			...
			/* Credit Notes */
			{
				...
				returnParameters: 'creditnote,creditnote.lineitem,creditnote.contactbusiness',	
	...
	"export":	function (oParam)
	{
		...
		if (oParam.exportStep == 0)
		{
			aHTML = '<table id="1blankspaceReportProgressList" class="ns1blankspace">' +
						...
						'<tr id="ns1blankspaceReportExportCountRow"><td id="ns1blankspaceReportExportCount" class="ns1blankspaceCaption">' +
								'Report Rows:' +
							'</td>' +
							'<td class="ns1blankspaceCaption" style="font-weight: normal;">' + 
								iCount + 
							'</td>' +
							'<td class="ns1blankspace"><span id="ns1blankspaceReportExportAction">' +
								'Continue</span>' +
							'</td></tr>' +
		...
		else if (oParam.exportStep === 3)
		{
			...
			if (ns1blankspace.supportAdmin)
			{
				$('#ns1blankspaceReportExportProgress')
					.before('<tr><td colspan="3">Constructing file :' + Date() + '</td></tr>');
			}
