						...
						show: function (oParam, oResponse)
								{
									...
									if (oResponse == undefined)
									{
										...
										if (ns1blankspace.objectContextData.participantcan)
										{
											...
											.click(function() 
											{
												ns1blankspace.messaging.conversation.posts.show({searchText: $('#ns1blankspacePostsSearchText').val()});
											})
											.css('width', '65px');
											...
											.click(function() 
											{
												ns1blankspace.messaging.conversation.posts.show({searchText: undefined});
											})
											.css('width', '65px');
