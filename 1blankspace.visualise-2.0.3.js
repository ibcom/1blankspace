					...
					svgToImage: function (oParam)
								{
									...
									var sBoxHeight = (parseInt(sHeight) * 1.2)
									var sBoxWidth = (parseInt(sWidth) * 1.2)
									...
									{ 
										var html = '<svg viewBox="0 0 ' + sBoxWidth + ' ' + sBoxHeight + '" version="1.1" xmlns="http://www.w3.org/2000/svg" width="275" height="' + sHeight + '" style="width:275px; height:' + sHeight + 'px;">' +
												sStyles + 
												$('#' + sXHTMLElementSVGContainerID)
									      	  	.attr("version", 1.1)
									        	.attr("xmlns", "http://www.w3.org/2000/svg")
